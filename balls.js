function balls(input) {
  ...
  for (let ball = 0; ball < ballNum; ball++) {
  ...
  console.log(
    `Total points: ${ballPoints}\nRed balls: ${redBall}\nOrange balls: ${orangeBall}\nYellow balls: ${yellowBall}\nWhite balls: ${whiteBall}\nOther colors picked: ${otherBall}\nDivides from black balls: ${blackBall}`
  );
}
