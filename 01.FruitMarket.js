function fruitMarket(arg1, arg2, arg3, arg4, arg5){
    const strawberryPrice = Number(arg1);
    const bananaQuantity = Number(arg2);
    const orangeQuantity = Number(arg3);
    const raspberryQuantity = Number(arg4);
    const strawberryQuantity = Number(arg5);
    const raspberryPrice = strawberryPrice * 0.5;
    const orangePrice = raspberryPrice * 0.6;
    const bananaPrice = raspberryPrice * 0.2;
    const totalPrice = strawberryPrice * strawberryQuantity + bananaQuantity * bananaPrice + orangeQuantity * orangePrice + raspberryQuantity * raspberryPrice;
